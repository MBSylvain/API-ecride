...
--
-- Hôte : 127.0.0.1
-- Généré le : sam. 24 mai 2025 à 19:18
...
CREATE DATABASE IF NOT EXISTS `covoiturage_db` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `covoiturage_db`;
...
INSERT INTO `avis` (`avis_id`, `auteur_id`, `destinataire_id`, `trajet_id`, `commentaire`, `note`, `date_creation`, `statut`) VALUES
(1, 3, 1, 1, 'Très bon conducteur, ponctuel et voiture confortable', 5, '2025-04-23 22:25:22', 'publié'),
(2, 1, 2, 2, 'Trajet agréable mais un peu de retard au départ', 4, '2025-04-23 22:25:22', 'publié'),
(3, 2, 4, 4, 'Excellent trajet, je recommande ce conducteur', 5, '2025-04-23 22:25:22', 'publié'),
(4, 11, 10, 8, 'Très bon conducteur, ponctuel et sympathique', 5, '2025-04-23 23:32:09', 'publié');
...
INSERT INTO `messages` (`message_id`, `expediteur_id`, `destinataire_id`, `trajet_id`, `contenu`, `date_envoi`, `lu`) VALUES
(1, 3, 1, 1, 'Bonjour, je suis intéressé par votre trajet Paris-Lyon. Où exactement partez-vous ?', '2025-04-23 22:25:22', 1),
(2, 1, 3, 1, 'Je pars de chez moi au 12 rue de la Paix. Ça vous convient ?', '2025-04-23 22:25:22', 1),
(3, 3, 1, 1, 'Parfait, c\'est à côté de mon travail. Je réserve !', '2025-04-23 22:25:22', 1),
(4, 2, 3, NULL, 'Salut Pierre, tu fais un trajet vers Nice bientôt ?', '2025-04-23 22:25:22', 0);
...
INSERT INTO `voiture` (`voiture_id`, `modele`, `marque`, `immatriculation`, `energie`, `couleur`, `date_premiere_immatriculation`, `nombre_places`, `photo_url`, `description`) VALUES
(1, 'Clio', 'opel', 'noeifjoefn', 'essence', 'feef', '2025-05-13', 4, '', ''),
(4, 'corsa D', 'Renault', '12-12-12', 'electrique', 'feef', '2025-04-30', 4, '', 'deccc'),
(6, 'SIVIC', 'HONDA', '14725-5-77', 'hybride', 'ULTRA VIOLET', '2025-04-28', 3, 'WWW.LOOOOL JE TAI EU', 'TU ES OU LA ');
...
--
ALTER TABLE `trajets`
  MODIFY `trajet_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT pour la table `utilisateurs`
--
ALTER TABLE `utilisateurs`
  MODIFY `utilisateur_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
